...
public final class BridgeServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "fr.lirmm.bridge.BridgeService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<fr.lirmm.bridge.FunctionCall,
      fr.lirmm.bridge.FunctionResult> getExecuteMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Execute",
      requestType = fr.lirmm.bridge.FunctionCall.class,
      responseType = fr.lirmm.bridge.FunctionResult.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<fr.lirmm.bridge.FunctionCall,
      fr.lirmm.bridge.FunctionResult> getExecuteMethod() {
    io.grpc.MethodDescriptor<fr.lirmm.bridge.FunctionCall, fr.lirmm.bridge.FunctionResult> getExecuteMethod;
      ...
      synchronized (BridgeServiceGrpc.class) {
        if ((getExecuteMethod = BridgeServiceGrpc.getExecuteMethod) == null) {
          BridgeServiceGrpc.getExecuteMethod = getExecuteMethod =
              io.grpc.MethodDescriptor.<fr.lirmm.bridge.FunctionCall, fr.lirmm.bridge.FunctionResult>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Execute"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  fr.lirmm.bridge.FunctionCall.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  fr.lirmm.bridge.FunctionResult.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    default void execute(fr.lirmm.bridge.FunctionCall request,
        io.grpc.stub.StreamObserver<fr.lirmm.bridge.FunctionResult> responseObserver) {
  ...
  public static final class BridgeServiceFutureStub
    ...
    public com.google.common.util.concurrent.ListenableFuture<fr.lirmm.bridge.FunctionResult> execute(
        fr.lirmm.bridge.FunctionCall request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_EXECUTE:
          serviceImpl.execute((fr.lirmm.bridge.FunctionCall) request,
              (io.grpc.stub.StreamObserver<fr.lirmm.bridge.FunctionResult>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              fr.lirmm.bridge.FunctionCall,
              fr.lirmm.bridge.FunctionResult>(
  ...
  private static abstract class BridgeServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return fr.lirmm.bridge.BridgeProto.getDescriptor();
    }
