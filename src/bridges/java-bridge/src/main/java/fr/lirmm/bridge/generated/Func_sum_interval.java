...
/**
 * AUTO-GENERATED WRAPPER FOR PYTHON FUNCTION 'sum_interval'
 * Source: @user_func in Python
 */
public class Func_sum_interval {
    ...
    /**
     * Executes the python function 'sum_interval' transparently.
     * @param args Arguments to pass to Python
     * @return Result from Python (typed as Object, cast as needed)
     */
    public static Object run(Object... args) {
        if (bridge == null) {
            throw new RuntimeException("Bridge not initialized! Call Func_sum_interval.setBridge(service) first.");
        }
        try {
            return bridge.callPython("sum_interval", args);
        } catch (Exception e) {
            throw new RuntimeException("Failed to execute python function 'sum_interval'", e);
        }
    }
