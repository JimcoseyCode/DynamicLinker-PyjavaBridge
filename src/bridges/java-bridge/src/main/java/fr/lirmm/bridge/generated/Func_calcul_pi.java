...
/**
 * AUTO-GENERATED WRAPPER FOR PYTHON FUNCTION 'calcul_pi'
 * Source: @user_func in Python
 */
public class Func_calcul_pi {
    ...
    /**
     * Executes the python function 'calcul_pi' transparently.
     * @param args Arguments to pass to Python
     * @return Result from Python (typed as Object, cast as needed)
     */
    public static Object run(Object... args) {
        if (bridge == null) {
            throw new RuntimeException("Bridge not initialized! Call Func_calcul_pi.setBridge(service) first.");
        }
        try {
            return bridge.call("calcul_pi", args);
        } catch (Exception e) {
            throw new RuntimeException("Failed to execute python function 'calcul_pi'", e);
        }
    }
