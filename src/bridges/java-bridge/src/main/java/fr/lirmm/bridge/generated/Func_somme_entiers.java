...
/**
 * AUTO-GENERATED WRAPPER FOR PYTHON FUNCTION 'somme_entiers'
 * Source: @user_func in Python
 */
public class Func_somme_entiers {
    ...
    /**
     * Executes the python function 'somme_entiers' transparently.
     * @param args Arguments to pass to Python
     * @return Result from Python (typed as Object, cast as needed)
     */
    public static Object run(Object... args) {
        if (bridge == null) {
            throw new RuntimeException("Bridge not initialized! Call Func_somme_entiers.setBridge(service) first.");
        }
        try {
            return bridge.callPython("somme_entiers", args);
        } catch (Exception e) {
            throw new RuntimeException("Failed to execute python function 'somme_entiers'", e);
        }
    }
