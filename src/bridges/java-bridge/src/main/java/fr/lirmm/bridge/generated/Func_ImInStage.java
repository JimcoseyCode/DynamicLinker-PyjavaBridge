...
/**
 * AUTO-GENERATED WRAPPER FOR PYTHON FUNCTION 'ImInStage'
 * Source: @user_func in Python
 */
public class Func_ImInStage {
    ...
    /**
     * Executes the python function 'ImInStage' transparently.
     * @param args Arguments to pass to Python
     * @return Result from Python (typed as Object, cast as needed)
     */
    public static Object run(Object... args) {
        if (bridge == null) {
            throw new RuntimeException("Bridge not initialized! Call Func_ImInStage.setBridge(service) first.");
        }
        try {
            return bridge.callPython("ImInStage", args);
        } catch (Exception e) {
            throw new RuntimeException("Failed to execute python function 'ImInStage'", e);
        }
    }
