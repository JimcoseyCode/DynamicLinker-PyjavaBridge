...
/**
 * AUTO-GENERATED WRAPPER FOR PYTHON FUNCTION 'main'
...
public class Func_main {
    ...
    /**
     * Executes the python function 'main' transparently.
     * @param args Arguments to pass to Python
     * @return Result from Python (typed as Object, cast as needed)
     */
    public static Object run(Object... args) {
        if (bridge == null) {
            throw new RuntimeException("Bridge not initialized! Call Func_main.setBridge(service) first.");
        }
        try {
            return bridge.callPython("main", args);
        } catch (Exception e) {
            throw new RuntimeException("Failed to execute python function 'main'", e);
        }
    }
